...
benchmarks_linalg = [
    ...
    Benchmark('3mm.mlir', '3mm',
              ['linalg.matvec'], True, 1),
    Benchmark('bicg.mlir', 'bicg',
              ['linalg.matvec'], True, 1),
    # Benchmark('from_mlt/gemm.mlir', 'gemm',
...
def run_benchmark(dialect, benchmark, prune_equivalent_candidates, ops, distribute, max_num_ops):
    ...
    filename = os.path.join(SCRIPT_DIR, 'polybench', benchmark.file)
