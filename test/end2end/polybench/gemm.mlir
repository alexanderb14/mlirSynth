// RUN: synthesizer %s --num-threads=32 --ignore-equivalent-candidates --ops=chlo.broadcast_add,mhlo.dot,chlo.broadcast_multiply --distribute --max-num-ops=4 | FileCheck %s
