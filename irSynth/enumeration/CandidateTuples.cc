...
// scripts/gen_CandidateTuples.py
...
std::vector<CandidateTuple> get0operands0attributes1regions(
...
std::vector<CandidateTuple> get0operands0attributes2regions(
    std::vector<CandidatePtr> &operandCandidates,
    std::vector<Attribute> &attributeCandidates,
    std::vector<std::shared_ptr<Region>> &regionCandidates) {
  auto cands =
...
std::vector<CandidateTuple> get0operands1attributes0regions(
    std::vector<CandidatePtr> &operandCandidates,
    std::vector<Attribute> &attributeCandidates,
    std::vector<std::shared_ptr<Region>> &regionCandidates) {
...
std::vector<CandidateTuple> get0operands1attributes1regions(
    std::vector<CandidatePtr> &operandCandidates,
    std::vector<Attribute> &attributeCandidates,
    std::vector<std::shared_ptr<Region>> &regionCandidates) {
  auto cands =
...
std::vector<CandidateTuple> get0operands1attributes2regions(
    std::vector<CandidatePtr> &operandCandidates,
    std::vector<Attribute> &attributeCandidates,
    std::vector<std::shared_ptr<Region>> &regionCandidates) {
...
std::vector<CandidateTuple> get0operands2attributes0regions(
    std::vector<CandidatePtr> &operandCandidates,
    std::vector<Attribute> &attributeCandidates,
    std::vector<std::shared_ptr<Region>> &regionCandidates) {
  auto cands = ranges::views::cartesian_product(attributeCandidates,
...
std::vector<CandidateTuple> get0operands2attributes1regions(
    std::vector<CandidatePtr> &operandCandidates,
    std::vector<Attribute> &attributeCandidates,
    std::vector<std::shared_ptr<Region>> &regionCandidates) {
  auto cands = ranges::views::cartesian_product(
...
std::vector<CandidateTuple> get0operands2attributes2regions(
    std::vector<CandidatePtr> &operandCandidates,
    std::vector<Attribute> &attributeCandidates,
    std::vector<std::shared_ptr<Region>> &regionCandidates) {
  auto cands =
...
std::vector<CandidateTuple> get1operands0attributes0regions(
    std::vector<CandidatePtr> &operandCandidates,
    std::vector<Attribute> &attributeCandidates,
    std::vector<std::shared_ptr<Region>> &regionCandidates) {
...
std::vector<CandidateTuple> get1operands0attributes1regions(
    std::vector<CandidatePtr> &operandCandidates,
    std::vector<Attribute> &attributeCandidates,
    std::vector<std::shared_ptr<Region>> &regionCandidates) {
  auto cands =
...
std::vector<CandidateTuple> get1operands0attributes2regions(
    std::vector<CandidatePtr> &operandCandidates,
    std::vector<Attribute> &attributeCandidates,
    std::vector<std::shared_ptr<Region>> &regionCandidates) {
  auto cands = ranges::views::cartesian_product(
...
std::vector<CandidateTuple> get1operands1attributes0regions(
    std::vector<CandidatePtr> &operandCandidates,
    std::vector<Attribute> &attributeCandidates,
    std::vector<std::shared_ptr<Region>> &regionCandidates) {
  auto cands =
...
std::vector<CandidateTuple> get1operands1attributes1regions(
    std::vector<CandidatePtr> &operandCandidates,
    std::vector<Attribute> &attributeCandidates,
    std::vector<std::shared_ptr<Region>> &regionCandidates) {
  auto cands = ranges::views::cartesian_product(
...
std::vector<CandidateTuple> get1operands1attributes2regions(
    std::vector<CandidatePtr> &operandCandidates,
    std::vector<Attribute> &attributeCandidates,
    std::vector<std::shared_ptr<Region>> &regionCandidates) {
  auto cands =
...
std::vector<CandidateTuple> get1operands2attributes0regions(
    std::vector<CandidatePtr> &operandCandidates,
    std::vector<Attribute> &attributeCandidates,
    std::vector<std::shared_ptr<Region>> &regionCandidates) {
  auto cands = ranges::views::cartesian_product(
...
std::vector<CandidateTuple> get1operands2attributes1regions(
    std::vector<CandidatePtr> &operandCandidates,
    std::vector<Attribute> &attributeCandidates,
    std::vector<std::shared_ptr<Region>> &regionCandidates) {
  auto cands =
...
std::vector<CandidateTuple> get1operands2attributes2regions(
    std::vector<CandidatePtr> &operandCandidates,
    std::vector<Attribute> &attributeCandidates,
    std::vector<std::shared_ptr<Region>> &regionCandidates) {
  auto cands = ranges::views::cartesian_product(
...
std::vector<CandidateTuple> get2operands0attributes0regions(
    std::vector<CandidatePtr> &operandCandidates,
    std::vector<Attribute> &attributeCandidates,
    std::vector<std::shared_ptr<Region>> &regionCandidates) {
  auto cands =
...
std::vector<CandidateTuple> get2operands0attributes1regions(
    std::vector<CandidatePtr> &operandCandidates,
    std::vector<Attribute> &attributeCandidates,
    std::vector<std::shared_ptr<Region>> &regionCandidates) {
  auto cands = ranges::views::cartesian_product(
...
std::vector<CandidateTuple> get2operands0attributes2regions(
    std::vector<CandidatePtr> &operandCandidates,
    std::vector<Attribute> &attributeCandidates,
    std::vector<std::shared_ptr<Region>> &regionCandidates) {
  auto cands = ranges::views::cartesian_product(
...
std::vector<CandidateTuple> get2operands1attributes0regions(
    std::vector<CandidatePtr> &operandCandidates,
    std::vector<Attribute> &attributeCandidates,
    std::vector<std::shared_ptr<Region>> &regionCandidates) {
  auto cands = ranges::views::cartesian_product(
...
std::vector<CandidateTuple> get2operands1attributes1regions(
    std::vector<CandidatePtr> &operandCandidates,
    std::vector<Attribute> &attributeCandidates,
    std::vector<std::shared_ptr<Region>> &regionCandidates) {
  auto cands =
...
std::vector<CandidateTuple> get2operands1attributes2regions(
    std::vector<CandidatePtr> &operandCandidates,
    std::vector<Attribute> &attributeCandidates,
    std::vector<std::shared_ptr<Region>> &regionCandidates) {
  auto cands = ranges::views::cartesian_product(
...
std::vector<CandidateTuple> get2operands2attributes0regions(
    std::vector<CandidatePtr> &operandCandidates,
    std::vector<Attribute> &attributeCandidates,
    std::vector<std::shared_ptr<Region>> &regionCandidates) {
  auto cands = ranges::views::cartesian_product(
...
std::vector<CandidateTuple> get2operands2attributes1regions(
    std::vector<CandidatePtr> &operandCandidates,
    std::vector<Attribute> &attributeCandidates,
    std::vector<std::shared_ptr<Region>> &regionCandidates) {
  auto cands = ranges::views::cartesian_product(
...
std::vector<CandidateTuple> get2operands2attributes2regions(
    std::vector<CandidatePtr> &operandCandidates,
    std::vector<Attribute> &attributeCandidates,
    std::vector<std::shared_ptr<Region>> &regionCandidates) {
  auto cands = ranges::views::cartesian_product(
