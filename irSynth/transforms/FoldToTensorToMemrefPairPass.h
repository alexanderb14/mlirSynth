...
std::unique_ptr<mlir::OperationPass<mlir::ModuleOp>> createFoldToTensorToMemrefPairPass();
...
struct FoldToTensorToMemrefPairPass
  ...
  llvm::StringRef getArgument() const override { return "fold-totensor-tomemref-pairs"; }
...
namespace mlir {
inline void registerFoldToTensorToMemrefPairPass() { PassRegistration<FoldToTensorToMemrefPairPass>(); }
} // namespace mlir
